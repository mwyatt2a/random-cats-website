...
init().then(() => {
    console.log(test(5));
    console.log(GraphicsMatrix.create_translation_matrix(Translation.js_create(50, 7.9, 23)).get_data());
    console.log(GraphicsMatrix.create_rotation_matrix(Rotation.js_create(0, 0, 0)).get_data());
